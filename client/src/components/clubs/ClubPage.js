    ...
    switch (this.state.display) {
        ...
        return (
          ...
          >
            ...
            club1.president === this.props.auth.user.name ? (
              ...
              >
               Clube Name :  {club1.name}
              </b>
            )}
            <br /><b className="info_about">
            Category:</b>{" "}
            {this.state.editMode &&
            this.props.auth.isAuthenticated &&
      ...
      case "about":
        return (
          ...
          >
            <b className=" Titels" style={{ fontWeight: "600", fontSize: "50px" }}>
              About:
            </b>
            <br />
            <b className="info_about"  class="info_about">
            Club President 👑 : </b>{club1.president} 
            <br />
            <br />
            <b className="info_about">
            About:</b>{" "}
            {this.state.editMode &&
            this.props.auth.isAuthenticated &&
            club1.staff.indexOf(this.props.auth.user.name) > -1 ? (
      ...
      case "announcements":
        return (
          <div //Announcements
            ...
            style={{ paddingTop: "20px", color: "grey", fontSize: "18px" }}
          >
            <b class="Titels"style={{ fontWeight: "600", fontSize: "48px",  }}>
              Announcements : 
            </b>
            <br />
            {this.state.editMode &&
      ...
      case "discussions":
        return (
          <div //Discussions
            ...
            style={{ paddingTop: "20px", color: "grey", fontSize: "18px" }}
          >
            <b className ="Titels" style={{ fontWeight: "600", fontSize: "48px", }}>
              Discussions  :
            </b>
            {this.state.editMode &&
            this.props.auth.isAuthenticated &&
      ...
      case "members":
        return (
          <div //Members
            ...
            style={{ paddingTop: "20px", color: "grey", fontSize: "18px" }}
          >
            <b className=" Titels" style={{ fontWeight: "600", fontSize: "48px", color: "black" }}>
              Members : 
            </b>
            <br />
            ...
            <Layout>
              ...
              >
                <ul style={{ listStyle: "none" }}>
                  ...
                  <li style={{ marginLeft: "-20px",paddingTop: "10px" }}>
                  <div 
                      className="sideMenuBtns"
                      href="#"
                      style={{
